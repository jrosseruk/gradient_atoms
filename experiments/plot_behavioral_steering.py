...
EVAL_DIR = os.path.join(PROJECT_ROOT, "results_alpha01", "eval_behavioral")
...
plt.tight_layout()
out_path = os.path.join(PROJECT_ROOT, "figures", "behavioral_steering.pdf")
