...
Adapts the experiments_subl_learn config for the infusion pipeline:
  1. Train on 5K clean docs (no UK preference)
  2. EKFAC factor fitting + influence scoring
  3. Infusion (PGD perturbation) of 500 docs toward UK preference
...
INFUSION_ROOT = EXPERIMENTS_ROOT.parent.parent   # gradient_atoms/
