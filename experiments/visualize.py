...
Usage:
    ...
    python experiments/visualize.py --port 7860
"""
...
def main():
    ...
    atoms_001 = load_atoms(os.path.join(PROJECT_ROOT, "results"))
    atoms_01 = load_atoms(os.path.join(PROJECT_ROOT, "results_alpha01"))
    ...
    docs_path = os.path.join(PROJECT_ROOT, "results", "training_docs_compact.json")
    training_docs = []
